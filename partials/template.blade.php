<div>
  <h1>  &emsp    Welcome to AMPGateway for Atomic and Molecular Physics</h1>
      <p style="color:#cccccc;">
      <!-- h2>Welcome!</h2 -->
      </p>
      <hr/>

  <img class="img-responsive" src="{{ URL::to('/') }}/themes/{{Session::get('theme')}}/assets/img/amp-banner1.png" width="100%" height="20%"/>
  <!--
    <h1>Hero Image</h1>
